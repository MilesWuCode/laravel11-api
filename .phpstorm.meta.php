...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Interfaces\PostRepositoryInterface' => \App\Repositories\PostRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/miles/github/laravel11-api/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.media.driver','filesystems.disks.media.root',
'filesystems.disks.media.url','filesystems.links./home/miles/github/laravel11-api/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'media-library.enable_vapor_uploads','media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','query-builder.parameters.include',
...
'hashing.rehash_on_login','concurrency.default','view.paths','view.compiled','structure-discoverer.ignored_files',
...
'signed','throttle','verified','cache.response',);
        registerArgumentsSet('routes', 
'scramble.docs.ui','scramble.docs.document','sanctum.csrf-cookie','todos.index',
'todos.store','todos.show','todos.update','todos.destroy','posts.index',
'posts.store','posts.show','posts.update','posts.destroy','storage.local',);
...
'VITE_APP_NAME','MEDIA_DISK','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET',);
